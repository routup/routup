...
export function createNodeResponse(request: NodeRequest) : NodeResponse {
    ...
    Object.assign(writable, {
        ...
        appendHeader(name: string, value: string | ReadonlyArray<string>): NodeResponse {
        ...
        setHeader(name: string, value: number | string | string[]): NodeResponse {
            headers[name.toLowerCase()] = value;
            return this as NodeResponse;
        },
        setTimeout(_msecs: number, _callback: (() => void) | undefined): NodeResponse {
            return this as NodeResponse;
        },
    ...
    } satisfies Omit<NodeResponse, keyof NodeWritable>);

    return writable as NodeResponse;
}
