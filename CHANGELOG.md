...
* **app:** promote plugin surface to IApp; drop dead error class ([#916](https://github.com/routup/routup/issues/916))
* **plugin:** silent-skip install model; add singleton and singletonByPath flags ([#915](https://github.com/routup/routup/issues/915))
* drop clone() from App, IRouter, ICache ([#914](https://github.com/routup/routup/issues/914))
...
* **plugin:** silent-skip install model; add singleton and singletonByPath flags ([#915](https://github.com/routup/routup/issues/915)) ([efe39cd](https://github.com/routup/routup/commit/efe39cd73389b93abcca59ec00b53d9fe1f206e9))
...
* **deps:** bump codecov/codecov-action from 5.4.3 to 6.0.1 ([#918](https://github.com/routup/routup/issues/918)) ([8abd1fa](https://github.com/routup/routup/commit/8abd1faff57f6b89633cd3d1710d799b11eca619))
...
* remove unused object helpers ([f3e9585](https://github.com/routup/routup/commit/f3e9585d337c5f6199f3fc8c265be507979ba3ef))
...
* **app:** promote plugin surface to IApp; drop dead error class ([#916](https://github.com/routup/routup/issues/916)) ([efd3754](https://github.com/routup/routup/commit/efd3754cf40bf44e632e87426ae90d352e8205c2))
* drop clone() from App, IRouter, ICache ([#914](https://github.com/routup/routup/issues/914)) ([cd873e0](https://github.com/routup/routup/commit/cd873e06a8828b39bb30d0560fc1f9dad04c26d6))
* **response:** drop sendCreated / sendAccepted helpers ([b7ab571](https://github.com/routup/routup/commit/b7ab571d83a5222b3b186ce662635621172daa40))
...
* **plugin:** Plugins no longer declare dependencies. The fields `Plugin.dependencies` and `PluginDependency` are removed, along with `PluginDependencyError`, `satisfiesVersion`, and the entire `src/plugin/semver.ts` utility. `hasPlugin` and `getPluginVersion` now look up only the calling router (no parent traversal, no descent).
...
* **docs:** add plugin authoring guide ([8c1a250](https://github.com/routup/routup/commit/8c1a25081a58e3caee0b6ebb249fb9b0622f330e))
* **docs:** link to plugins.routup.dev from the top nav ([43be339](https://github.com/routup/routup/commit/43be33935340fab2d7e78d6bd32205a43f0e5181))
* **docs:** rebuild landing page on marketing-hero pattern ([fc8d6a8](https://github.com/routup/routup/commit/fc8d6a830dc9727d2c2e09d49d0f0d2fb64f90a3))
...
* **handler:** redefine undefined-return contract ([#873](https://github.com/routup/routup/issues/873)) ([bf62a35](https://github.com/routup/routup/commit/bf62a35b1aa3eb3413d7b0cb089162430d922aab))
...
* **plugin:** expose wrapper-bundled plugins to dependency checks ([#875](https://github.com/routup/routup/issues/875)) ([91f6199](https://github.com/routup/routup/commit/91f6199ec478ffea7858314a7cbd6255036ca854))
* **plugin:** tighten semver and registry semantics ([#872](https://github.com/routup/routup/issues/872)) ([97adf41](https://github.com/routup/routup/commit/97adf4194128df70813bf3ec83b0d556318aea96))
...
* **router:** restore routing state when a child entry yields no response ([274fa34](https://github.com/routup/routup/commit/274fa346fa4a57b6157facc339f49d2b83f2c4d0))
