...
console.log(`runtime=${RUNTIME}  resolver=${process.env.RESOLVER ?? 'linear'}  cache=${process.env.CACHE ?? 'lru'}  url=${URL}  trials=${TRIALS} warmup=${WARMUP}s duration=${DURATION}s connections=${CONNECTIONS} pipelining=${PIPELINING}`);
